...
public class AjoutBase {
    ...
    public static void main(String[] args) {
        ...
        for (Long localI = 1L; localI < 21; localI++) {
            ...
            localLigneCommande.setDateCommande(new Date());
            ...
            for (int localI2 = 0; localI2 < nbLigne; localI2++) {
                ...
                fournDocument.append("idFournisseur", localLigneCommande.getProduit().getFournisseur().getId());
                fournDocument.append("nomFournisseur", localLigneCommande.getProduit().getFournisseur().getNom());
